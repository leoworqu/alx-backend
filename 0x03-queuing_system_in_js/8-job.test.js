...
describe('createPushNotificationsJobs', () => {
  ...
  it('display a error message if jobs is not an array is Number', () => {
    expect(() => {
      createPushNotificationsJobs(2, queue);
    }).to.throw('Jobs is not an array');
  });

  it('display a error message if jobs is not an array is String', () => {
    expect(() => {
      createPushNotificationsJobs('Hello', queue);
    }).to.throw('Jobs is not an array');
  });

  it('display a error message if jobs is not an array is Object', () => {
    expect(() => {
